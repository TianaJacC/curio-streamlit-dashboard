...
# ... (您的其他初始化與 Flask 路由設定維持不變) ...

def get_drink_carousel_message():
    """
    產生「夢境珍奇櫃」高奢黑金莫蘭迪風格的飲品介紹輪播卡片
    """
    flex_content = {
      "type": "carousel",
      "contents": [
        {
          ...
          "size": "mega",
          "styles": {
            "header": { "backgroundColor": "#142017" },
            "body": { "backgroundColor": "#0A110D" },
            "footer": { "backgroundColor": "#142017" }
          },
          "header": {
            "type": "box",
            "layout": "vertical",
            ...
            "contents": [
              ...
              },
              {
                ...
                "contents": [
                  {
                    "type": "text",
                    "text": "核心調適機能：溫和護胃、驅散腦霧，快速喚醒前額葉心流專注。",
                    "color": "#A2B3A7",
                    "size": "xs",
                    "wrap": True
                  }
            ...
            "contents": [
              ...
              },
              {
                ...
                "contents": [
                  {
                    "type": "text",
                    "text": "核心調適機能：誘導迷走神經共振，平息思慮反芻、安穩入眠。",
                    "color": "#A2B3A7",
                    "size": "xs",
                    "wrap": True
                  }
    ...
    return FlexSendMessage(alt_text="夢境珍奇櫃 ‧ 頂級茶品圖鑑", contents=json.loads(json_str))
...
def handle_text_message(event):
    ...
    # 當使用者傳送「飲品介紹」時觸發
    if user_text == "飲品介紹":
        flex_msg = get_drink_carousel_message()
        line_bot_api.reply_message(event.reply_token, flex_msg)
    else:
        # 其他預設回覆邏輯
        line_bot_api.reply_message(
            event.reply_token,
            TextSendMessage(text=f"已收到您的訊息：{user_text}")
        )
